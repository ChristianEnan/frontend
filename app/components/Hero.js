...
class Particle {
  ...
  draw() {
    ...
    this.ctx.fillStyle = `rgba(124, 58, 237, ${this.opacity})`;
    this.ctx.fill();
  }
}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
        ...
        {/* CTAs + Social Links (aligned) */}
        <div className="flex flex-col items-center gap-4" style={{ animation: "slide-up 0.8s ease forwards 0.8s", opacity: 0 }}>
          ...
          <div className="flex items-center justify-center gap-3 mt-1">
            {[
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border bg-surface/50 text-muted transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:text-primary-light hover:shadow-lg hover:shadow-primary/10"
              >
                {social.icon}
              </a>
            ))}
